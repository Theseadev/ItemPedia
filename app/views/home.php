...
<section class="relative pt-3 pb-4 sm:pt-6 sm:pb-8 overflow-hidden">
    ...
    <div class="max-w-7xl mx-auto px-3.5 sm:px-6 lg:px-8 relative z-10">
        ...
        <div class="mt-3 sm:mt-5 bg-white/95 backdrop-blur-md rounded-2xl sm:rounded-3xl border-2 border-sky-100 shadow-card p-3 sm:p-4">
            <div class="flex flex-col md:flex-row items-center justify-between gap-3">
                ...
                <form action="/#katalog" method="GET" class="w-full md:w-1/2 relative">
                    <input type="text" 
                           ...
                           class="w-full pl-9 pr-20 sm:pl-11 sm:pr-24 py-2 sm:py-2.5 bg-slate-50 border-2 border-slate-200 hover:border-sky-300 focus:border-sky-500 focus:bg-white rounded-xl sm:rounded-2xl text-xs sm:text-sm font-bold text-slate-900 placeholder-slate-400 transition-all outline-none">
                ...
                <!-- Quick Tags -->
                <div class="flex items-center gap-1.5 sm:gap-2 flex-wrap text-[10px] sm:text-[11px] font-bold text-slate-500 w-full md:w-auto">
                    <span class="text-slate-400 font-extrabold flex items-center gap-1">
                        <i class="fa-solid fa-fire text-amber-500"></i> Populer:
                    </span>
                    <a href="/?game=Build+A+Zoo#katalog" class="px-2.5 py-1 bg-sky-50 hover:bg-sky-100 text-sky-700 border border-sky-200/80 rounded-lg transition-colors">🐾 Build A Zoo</a>
                    <a href="/?kategori=akun-game#katalog" class="px-2.5 py-1 bg-indigo-50 hover:bg-indigo-100 text-indigo-700 border border-indigo-200/80 rounded-lg transition-colors">👑 Akun Polosan</a>
                    <a href="/?game=Chop+Your+Tree#katalog" class="px-2.5 py-1 bg-amber-50 hover:bg-amber-100 text-amber-800 border border-amber-200/80 rounded-lg transition-colors">🪓 Chop Your Tree</a>
                    <a href="/?game=Catch+and+Tame#katalog" class="px-2.5 py-1 bg-emerald-50 hover:bg-emerald-100 text-emerald-800 border border-emerald-200/80 rounded-lg transition-colors">⭐ Catch &amp; Tame</a>
                </div>
            </div>
        </div>
        ...
        <div class="pt-4 sm:pt-6 pb-1">
            <div class="bg-gradient-to-r from-sky-50/90 via-white to-blue-50/70 rounded-2xl sm:rounded-3xl border-2 border-sky-100 shadow-card p-3 sm:p-4 overflow-hidden relative group">
                ...
                <div class="flex flex-wrap items-center justify-between gap-2 px-1 mb-2.5 sm:mb-3">
                    <div class="flex items-center gap-2">
                        ...
                        <div class="flex items-center gap-1.5 text-xs font-black text-slate-800">
                            ...
                            <span class="hidden sm:inline text-slate-600 font-bold">Aktivitas Transaksi Pembeli Real-Time</span>
                        </div>
                    </div>

                    <div class="flex items-center gap-1.5 text-[10px] sm:text-[11px] font-bold text-sky-700 bg-sky-100/70 px-2 sm:px-2.5 py-0.5 sm:py-1 rounded-lg sm:rounded-xl">
                ...
                <div class="relative overflow-hidden w-full mask-linear-fade">
                    <div class="flex items-center gap-2.5 sm:gap-3 w-max animate-marquee-live py-0.5">
                        ...
                        <div class="flex items-center gap-2.5 bg-white hover:bg-sky-50/40 border border-slate-200/90 hover:border-sky-300 shadow-2xs hover:shadow-xs transition-all duration-200 rounded-xl sm:rounded-2xl px-2.5 py-1.5 sm:px-3 sm:py-2 min-w-[230px] sm:min-w-[270px] flex-shrink-0">
                            <!-- Avatar -->
                            <div class="relative w-8 h-8 sm:w-9 sm:h-9 rounded-lg sm:rounded-xl overflow-hidden bg-sky-50 border border-sky-100 flex-shrink-0">
                                ...
                                <div class="absolute bottom-0 right-0 w-2 h-2 sm:w-2.5 sm:h-2.5 bg-emerald-500 border border-white rounded-full"></div>
                            </div>
                            ...
                            <div class="flex-grow min-w-0 pr-1 text-left">
                                <div class="flex items-center justify-between gap-1">
                                    ...
                                    <span class="text-[8px] sm:text-[9px] font-extrabold text-emerald-700 bg-emerald-50 px-1 py-0.2 sm:px-1.5 sm:py-0.5 rounded flex items-center gap-0.5 flex-shrink-0">
                                        <?= htmlspecialchars($lp['time_ago']) ?>
                                    </span>
                                </div>
                                <div class="text-[10px] sm:text-[11px] font-bold text-slate-700 truncate mt-0.5" title="<?= htmlspecialchars($lp['product_name']) ?>">
                                    <?= htmlspecialchars($lp['product_name']) ?>
                                </div>
                                <div class="flex items-center justify-between gap-1 mt-0.5">
                                    <span class="text-[8px] sm:text-[9px] font-bold text-sky-600 bg-sky-50 px-1 py-0.2 rounded truncate max-w-[100px] sm:max-w-[120px]">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-2.5 sm:gap-4 pt-3 sm:pt-4 pb-2">
            ...
            <div class="interactive-card bg-white p-3.5 sm:p-5 rounded-2xl sm:rounded-3xl border-2 border-sky-100 hover:border-sky-300 shadow-card text-center group transition-all duration-200">
                <div class="w-10 h-10 sm:w-12 sm:h-12 rounded-xl sm:rounded-2xl bg-sky-50 text-sky-500 flex items-center justify-center mx-auto mb-2 sm:mb-2.5 border border-sky-200 group-hover:scale-110 group-hover:bg-sky-100 transition-all duration-300 text-lg sm:text-xl">
                    <i class="fa-solid fa-bolt"></i>
                </div>
                <div class="text-base sm:text-xl font-black text-sky-700">3 - 5 Mnt</div>
                <div class="text-[10px] sm:text-xs font-bold text-slate-600 mt-0.5">Rata-rata Pengiriman</div>
            </div>

            <!-- Card 2: 100% Anti Hack-Back -->
            <div class="interactive-card bg-white p-3.5 sm:p-5 rounded-2xl sm:rounded-3xl border-2 border-emerald-100 hover:border-emerald-300 shadow-card text-center group transition-all duration-200">
                <div class="w-10 h-10 sm:w-12 sm:h-12 rounded-xl sm:rounded-2xl bg-emerald-50 text-emerald-600 flex items-center justify-center mx-auto mb-2 sm:mb-2.5 border border-emerald-200 group-hover:scale-110 group-hover:bg-emerald-100 transition-all duration-300 text-lg sm:text-xl">
                    <i class="fa-solid fa-shield-halved"></i>
                </div>
                <div class="text-base sm:text-xl font-black text-emerald-700">100% Anti</div>
                <div class="text-[10px] sm:text-xs font-bold text-slate-600 mt-0.5">Garansi Akun Polosan</div>
            </div>

            <!-- Card 3: 2,400+ Transaksi Sukses -->
            <div class="interactive-card bg-white p-3.5 sm:p-5 rounded-2xl sm:rounded-3xl border-2 border-amber-100 hover:border-amber-300 shadow-card text-center group transition-all duration-200">
                <div class="w-10 h-10 sm:w-12 sm:h-12 rounded-xl sm:rounded-2xl bg-amber-50 text-amber-500 flex items-center justify-center mx-auto mb-2 sm:mb-2.5 border border-amber-200 group-hover:scale-110 group-hover:bg-amber-100 transition-all duration-300 text-lg sm:text-xl">
                    <i class="fa-solid fa-trophy"></i>
                </div>
                <div class="text-base sm:text-xl font-black text-amber-700">2,400+</div>
                <div class="text-[10px] sm:text-xs font-bold text-slate-600 mt-0.5">Transaksi Sukses</div>
            </div>

            <!-- Card 4: QRIS Instan Semua E-Wallet -->
            <div class="interactive-card bg-white p-3.5 sm:p-5 rounded-2xl sm:rounded-3xl border-2 border-blue-100 hover:border-blue-300 shadow-card text-center group transition-all duration-200">
                <div class="w-10 h-10 sm:w-12 sm:h-12 rounded-xl sm:rounded-2xl bg-blue-50 text-blue-600 flex items-center justify-center mx-auto mb-2 sm:mb-2.5 border border-blue-200 group-hover:scale-110 group-hover:bg-blue-100 transition-all duration-300 text-lg sm:text-xl">
                    <i class="fa-solid fa-qrcode"></i>
                </div>
                <div class="text-base sm:text-xl font-black text-blue-700">QRIS Instan</div>
                <div class="text-[10px] sm:text-xs font-bold text-slate-600 mt-0.5">Semua E-Wallet &amp; Bank</div>
            </div>
        </div>
...
<section class="max-w-7xl mx-auto px-3.5 sm:px-6 lg:px-8 -mt-2 mb-6 sm:mb-8 relative z-20">
    <div class="relative bg-gradient-to-r from-sky-100/90 via-sky-50/70 to-blue-100/80 rounded-2xl sm:rounded-3xl border-2 border-sky-200 shadow-soft-lg p-3.5 sm:p-6 overflow-hidden">
        
        <!-- Soft Ambient Light Glows -->
        <div class="absolute -right-12 -top-12 w-56 h-56 bg-sky-200/50 rounded-full blur-3xl pointer-events-none"></div>
        <div class="absolute -left-12 -bottom-12 w-56 h-56 bg-blue-200/40 rounded-full blur-3xl pointer-events-none"></div>

        <!-- Section Header -->
        <div class="relative z-10 flex flex-col sm:flex-row sm:items-center justify-between gap-2.5 sm:gap-3 mb-3.5 sm:mb-5 pb-3 sm:pb-4 border-b border-sky-200/80">
            
            <!-- Left: Title & Subtitle -->
            <div class="flex items-center gap-2.5 sm:gap-3">
                <div class="w-8 h-8 sm:w-10 sm:h-10 rounded-xl sm:rounded-2xl bg-gradient-to-tr from-sky-500 to-blue-600 text-white flex items-center justify-center text-sm sm:text-base shadow-sm ring-2 ring-white flex-shrink-0">
                    <i class="fa-solid fa-gamepad"></i>
                </div>
                <div>
                    <h3 class="text-xs sm:text-base font-black text-slate-900 uppercase tracking-wider flex items-center gap-1.5 sm:gap-2">
                        PILIH GAME ROBLOX
            ...
            <div class="flex items-center gap-2">
                <div class="inline-flex items-center gap-1.5 sm:gap-2 px-2.5 sm:px-3.5 py-1 sm:py-1.5 rounded-full text-[10px] sm:text-xs font-black text-sky-800 bg-white/95 border border-sky-200 shadow-2xs backdrop-blur-sm">
        ...
        <div class="relative z-10 grid grid-cols-2 sm:grid-cols-4 gap-2.5 sm:gap-4">
            ...
            <a href="/?game=<?= urlencode($g['id']) ?>#katalog" 
               ...
               class="game-selection-card interactive-card flex flex-col items-center p-2.5 sm:p-4 rounded-xl sm:rounded-2xl border-2 transition-all duration-300 group/card cursor-pointer <?= $isActiveGame ? 'bg-sky-50/90 border-sky-500 ring-4 ring-sky-200 shadow-md scale-105' : 'bg-white hover:bg-white border-slate-200/80 hover:border-sky-300 hover:shadow-card hover:-translate-y-0.5' ?>">
                ...
                <!-- Game Name -->
                <span class="game-name-label text-xs font-black text-center <?= $isActiveGame ? 'text-sky-700' : 'text-slate-800 group-hover/card:text-sky-600' ?> leading-tight">
                    <?= htmlspecialchars($g['name']) ?>
                </span>
                
                <span class="game-status-label text-[9px] sm:text-[10px] <?= $isActiveGame ? 'text-sky-600 font-black' : 'text-slate-400 font-bold' ?> mt-0.5">
...
<section class="max-w-7xl mx-auto px-3.5 sm:px-6 lg:px-8 py-4 sm:py-8 scroll-mt-24" id="katalog">
    ...
    <div class="mb-6 sm:mb-8 p-3.5 sm:p-4 rounded-2xl bg-rose-50 border-2 border-rose-300 text-rose-800 text-xs sm:text-sm flex items-center gap-3 shadow-sm animate-bounce-subtle">
    ...
    <div class="flex flex-col md:flex-row md:items-end justify-between gap-3 sm:gap-4 mb-4 sm:mb-8">
        <div>
            <div class="inline-flex items-center gap-1.5 sm:gap-2 text-[11px] sm:text-xs font-black uppercase tracking-wider text-sky-700 bg-sky-100 px-2.5 sm:px-3 py-1 rounded-lg border border-sky-200 mb-1.5 sm:mb-2">
        ...
        <div class="flex items-center gap-2">
            <a href="/#katalog" 
               ...
               class="px-3 py-1 rounded-xl bg-slate-200 hover:bg-slate-300 text-xs font-bold text-slate-700 transition flex items-center gap-1.5 cursor-pointer <?= $activeGame !== 'all' ? '' : 'hidden' ?>">
    ...
    <div class="bg-white p-2.5 sm:p-4 rounded-2xl sm:rounded-3xl border-2 border-sky-100 shadow-card mb-5 sm:mb-8 flex flex-col md:flex-row items-center justify-between gap-3 sm:gap-4">
        ...
        <form action="/#katalog" method="GET" class="w-full md:w-80 relative" id="catalogSearchForm">
            ...
            <input type="text" 
                    ...
                    class="w-full pl-9 pr-9 py-2 sm:py-2.5 bg-slate-50 border-2 border-slate-200 rounded-xl sm:rounded-2xl text-xs sm:text-sm text-slate-900 font-bold placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:bg-white transition">
            <i class="fa-solid fa-magnifying-glass absolute left-3 top-1/2 -translate-y-1/2 text-slate-400 text-xs"></i>
            <?php if (!empty($searchQuery)): ?>
            <a href="/?kategori=<?= htmlspecialchars($activeCategory) ?>&game=<?= urlencode($activeGame) ?>#katalog" class="absolute right-3 top-1/2 -translate-y-1/2 text-slate-400 hover:text-slate-700 text-xs" title="Hapus pencarian">
                <i class="fa-solid fa-xmark"></i>
            </a>
            <?php endif; ?>
        </form>
    ...
    <div class="text-center py-16 sm:py-20 bg-white rounded-2xl sm:rounded-3xl border-2 border-slate-200 shadow-card max-w-xl mx-auto px-4">
        <div class="w-14 h-14 sm:w-16 sm:h-16 rounded-2xl bg-slate-100 text-slate-400 flex items-center justify-center mx-auto text-xl sm:text-2xl mb-3">
            <i class="fa-solid fa-magnifying-glass"></i>
        </div>
        <h3 class="text-base sm:text-lg font-black text-slate-900 mb-1">Produk Tidak Ditemukan</h3>
        <p class="text-xs text-slate-500">Tidak ada produk yang cocok untuk pencarian atau filter saat ini.</p>
        <a href="/#katalog" class="inline-block mt-4 px-4 py-2 rounded-xl bg-sky-100 text-xs font-black text-sky-700 hover:bg-sky-200 transition">
            Lihat Semua Produk
        </a>
    </div>
    <?php else: ?>
    ...
    <div id="productGridContainer" class="grid grid-cols-3 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-1.5 sm:gap-4">
        ...
        <div onclick="openCheckoutModal(<?= htmlspecialchars(json_encode($p)) ?>)" 
             ...
             class="product-card-item bg-white rounded-lg sm:rounded-2xl border border-slate-200/90 shadow-2xs hover:shadow-lg hover:border-sky-300 hover:-translate-y-1 transition duration-200 flex flex-col justify-between overflow-hidden cursor-pointer group transform-gpu <?= $isCardVisible ? '' : 'hidden' ?>">
            
            <!-- Card Visual / Image: 16:9 Aspect Ratio matching Seller's Marketplace Banners -->
            <div class="relative aspect-video w-full bg-slate-50 overflow-hidden border-b border-slate-100">
            ...
            <div class="p-1.5 sm:p-3.5 flex flex-col flex-grow justify-between">
                <div>
                    ...
                    <h3 class="text-[10px] sm:text-[13px] font-bold text-slate-800 line-clamp-2 leading-tight sm:leading-snug group-hover:text-sky-600 transition-colors h-6 sm:h-9" title="<?= htmlspecialchars($p['name']) ?>">
                        <?= htmlspecialchars($p['name']) ?>
                    </h3>

                    <!-- Kategori / Subtitle (Itemku style: Pet, Egg, Food, Item, Akun) -->
                    <p class="text-[8.5px] sm:text-[11px] text-slate-400 font-medium mt-0.5 sm:mt-1 truncate">
                ...
                <div>
                    ...
                    <div class="mt-1 sm:mt-2.5 flex items-baseline gap-1 sm:gap-1.5 flex-wrap">
                        <span class="text-[11px] sm:text-base font-extrabold text-orange-500 tracking-tight">
                            Rp <?= number_format($p['price'], 0, ',', '.') ?>
                        </span>
                        <?php if ($p['price_original'] > $p['price']): ?>
                        <span class="text-[7.5px] sm:text-[10px] text-slate-400 line-through font-normal">
                    ...
                    <div class="flex items-center justify-between mt-1 sm:mt-2 pt-1 sm:pt-2 border-t border-slate-100 text-[8px] sm:text-[11px] text-slate-400 font-medium">
                        <span class="truncate pr-0.5">
                            <?= (int)($p['total_sold'] ?? 0) ?> Terjual <span class="hidden sm:inline text-slate-300">|</span> <span class="hidden sm:inline"><?php if ((int)$p['stock'] === 1): ?><span class="text-red-500 font-bold">Sisa 1</span><?php elseif ((int)$p['stock'] > 1): ?><span class="text-blue-600 font-bold">Stok <?= (int)$p['stock'] ?></span><?php else: ?><span class="text-rose-500 font-bold">Habis</span><?php endif; ?></span>
                        </span>
                        <span class="flex items-center gap-0.5 font-bold text-slate-700 flex-shrink-0">
                    ...
                    <div class="flex items-center gap-1 sm:gap-1.5 mt-1.5 sm:mt-2.5 pt-1 sm:pt-2 border-t border-slate-100">
                        <button type="button" 
                                onclick="event.stopPropagation(); addToCart(<?= htmlspecialchars(json_encode($p)) ?>, 1, false);" 
                                class="flex-1 py-1 sm:py-1.5 px-1 sm:px-2 bg-sky-50 hover:bg-sky-100 active:scale-95 text-sky-700 font-bold rounded-md sm:rounded-xl border border-sky-200/80 flex items-center justify-center gap-0.5 sm:gap-1 transition-all cursor-pointer shadow-2xs hover:shadow-xs group/btn"
                                title="Tambah ke keranjang belanja">
                            <i class="fa-solid fa-cart-plus text-sky-600 group-hover/btn:scale-110 transition-transform text-[10px] sm:text-[11px]"></i>
    ...
    <div id="noProductsFoundBox" class="text-center py-12 sm:py-16 bg-white rounded-2xl sm:rounded-3xl border-2 border-slate-200 shadow-sm max-w-md mx-auto my-6 px-4 <?= ($initialVisibleCount === 0) ? '' : 'hidden' ?>">
        <div class="w-12 h-12 sm:w-14 sm:h-14 rounded-2xl bg-sky-50 text-sky-500 flex items-center justify-center mx-auto text-lg sm:text-xl mb-3 border border-sky-100">
            <i class="fa-solid fa-boxes-stacked"></i>
        </div>
        <h3 class="text-sm sm:text-base font-black text-slate-900 mb-1">Belum Ada Produk</h3>
        <p class="text-xs text-slate-500 font-medium" id="noProductsText">
            Tidak ada produk untuk kategori "<?= htmlspecialchars(strtoupper($activeCatLower)) ?>" saat ini.
        </p>
        <button type="button" onclick="selectCategoryTab('semua', event)" class="inline-block mt-4 px-4 py-2 rounded-xl bg-sky-100 hover:bg-sky-200 text-xs font-black text-sky-700 transition cursor-pointer">
            Lihat Semua Produk
        </button>
    </div>
    <?php endif; ?>
...
<section class="max-w-7xl mx-auto px-3.5 sm:px-6 lg:px-8 py-8 sm:py-12 relative">
    <div class="flex flex-col sm:flex-row sm:items-end justify-between gap-3 max-w-2xl sm:max-w-none mx-auto mb-5 sm:mb-10 text-center sm:text-left">
        <div>
            <div class="inline-flex items-center gap-2 text-xs font-black uppercase tracking-wider text-emerald-800 bg-emerald-100 px-3.5 py-1 rounded-xl border border-emerald-200 mb-2">
                <i class="fa-solid fa-star text-emerald-600"></i>
                <span>Ulasan Pelanggan</span>
            </div>
            <h2 class="text-xl sm:text-3xl font-black text-slate-950 tracking-tight">
                TRANSAKSI TERBARU PEMBELI
            </h2>
            <p class="hidden sm:block text-xs font-semibold text-slate-500 mt-1">Ulasan nyata dari pembeli yang telah sukses bertransaksi</p>
        </div>
        ...
        <div class="flex md:hidden items-center justify-center gap-2.5 self-center sm:self-auto pt-1">
            <button type="button" 
                    ...
                    class="w-9 h-9 rounded-full bg-white border-2 border-slate-200 shadow-sm hover:bg-sky-50 active:scale-90 flex items-center justify-center text-slate-700 text-xs transition cursor-pointer"
                    aria-label="Ulasan Sebelumnya">
                <i class="fa-solid fa-chevron-left"></i>
            </button>
            <span id="reviewSlideCounter" class="text-xs font-black text-slate-600 min-w-[45px] text-center">
                1 / <?= count($reviews) ?>
            </span>
            <button type="button" 
        ...
        <div id="reviewSlideTrack" class="flex md:grid transition-transform duration-500 ease-in-out md:transform-none md:grid-cols-2 lg:grid-cols-3 gap-0 md:gap-6">
            <?php if (!empty($reviews)): ?>
                ...
                <div class="review-slide-item w-full min-w-full flex-shrink-0 md:w-auto md:min-w-0 p-1 md:p-0 select-none">
                    <div class="interactive-card bg-white p-4 sm:p-6 rounded-2xl sm:rounded-3xl border-2 border-slate-200/90 shadow-card flex flex-col justify-between space-y-3.5 hover:border-sky-300 transition-all h-full">
                            ...
                            <div class="flex items-center justify-between gap-2.5">
                                <div class="flex items-center gap-2.5 min-w-0">
                                    <img src="<?= htmlspecialchars($rev['roblox_avatar_url'] ?: 'https://ui-avatars.com/api/?name=' . urlencode($rev['roblox_username']) . '&background=38bdf8&color=fff') ?>" 
                                         ...
                                         class="w-10 h-10 sm:w-11 sm:h-11 rounded-full border-2 border-sky-400 object-cover bg-slate-50 flex-shrink-0">
                                    <div class="min-w-0">
                                        <div class="font-black text-xs sm:text-sm text-slate-950 flex items-center gap-1 truncate">
                                        ...
                                        <span class="text-[10px] sm:text-[11px] text-slate-500 font-bold block truncate" title="<?= htmlspecialchars($rev['product_name']) ?>">
                                ...
                                <div class="text-amber-400 text-[10px] sm:text-xs flex items-center flex-shrink-0">
                                    <?php for ($s = 1; $s <= 5; $s++): ?>
                                        <i class="fa-solid fa-star <?= $s <= (int)$rev['rating'] ? 'text-amber-400' : 'text-slate-200' ?>"></i>
                                    <?php endfor; ?>
                                </div>
                            </div>
                            <p class="text-[11px] sm:text-xs font-semibold text-slate-700 leading-relaxed italic line-clamp-3 sm:line-clamp-none">
                                "<?= htmlspecialchars($rev['comment']) ?>"
                            </p>
                        </div>
                        <div class="pt-2 border-t border-slate-100 flex items-center justify-between text-[10px] sm:text-[11px] text-slate-400 font-medium">
                ...
                <?php endforeach; ?>
            <?php else: ?>
                <div class="col-span-full text-center py-12 bg-white rounded-3xl border-2 border-slate-200 w-full">
                    <i class="fa-regular fa-comment-dots text-3xl text-slate-400 mb-2"></i>
                    <p class="text-sm font-bold text-slate-600">Belum ada ulasan saat ini.</p>
                    <p class="text-xs text-slate-400">Ulasan pelanggan nyata akan otomatis tampil di sini setelah pesanan selesai.</p>
                </div>
            <?php endif; ?>
        </div>
    </div>
    ...
    <div id="reviewDotsContainer" class="flex md:hidden items-center justify-center gap-1.5 mt-3.5">
        ...
        <button type="button" 
                ...
                class="review-dot h-1.5 rounded-full transition-all duration-300 cursor-pointer <?= $idx === 0 ? 'bg-sky-500 w-5' : 'bg-slate-300 w-2' ?>" 
...
<section class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    <div class="text-center mb-8">
        <div class="inline-flex items-center gap-2 text-xs font-black uppercase tracking-wider text-sky-700 bg-sky-100 px-3 py-1 rounded-full border border-sky-200 mb-2.5">
        ...
        <h2 class="text-2xl sm:text-3xl font-black text-slate-950 tracking-tight">PERTANYAAN UMUM (FAQ)</h2>
        <p class="text-xs font-bold text-slate-500 mt-1">Panduan singkat seputar transaksi di ItemPedia</p>
    </div>
    ...
    <div class="space-y-3.5">
        <?php if (!empty($faqs)): ?>
            <?php 
            $faqIcons = [
                ['icon' => 'fa-solid fa-gamepad', 'wrap' => 'bg-sky-50 border-sky-200 text-sky-600'],
                ['icon' => 'fa-solid fa-lock', 'wrap' => 'bg-indigo-50 border-indigo-200 text-indigo-600'],
                ['icon' => 'fa-solid fa-shield-halved', 'wrap' => 'bg-emerald-50 border-emerald-200 text-emerald-600'],
                ['icon' => 'fa-solid fa-credit-card', 'wrap' => 'bg-amber-50 border-amber-200 text-amber-600'],
                ['icon' => 'fa-solid fa-circle-question', 'wrap' => 'bg-purple-50 border-purple-200 text-purple-600']
            ];
            $i = 0;
            ?>
            ...
            $i++;
            ?>
            <details class="interactive-card bg-white rounded-2xl border-2 border-slate-200 p-5 cursor-pointer shadow-sm group">
                <summary class="font-black text-sm text-slate-900 flex items-center justify-between list-none">
                    ...
                    <i class="fa-solid fa-chevron-down text-xs text-sky-600 group-open:rotate-180 transition-transform"></i>
                </summary>
                <p class="text-xs font-semibold text-slate-600 mt-3 leading-relaxed border-t border-slate-100 pt-3 pl-11">
        ...
        <?php else: ?>
            <details class="interactive-card bg-white rounded-2xl border-2 border-slate-200 p-5 cursor-pointer shadow-sm group">
                <summary class="font-black text-sm text-slate-900 flex items-center justify-between list-none">
                    <div class="flex items-center gap-3">
                        <div class="w-8 h-8 rounded-xl bg-sky-50 border border-sky-100 text-sky-600 flex items-center justify-center flex-shrink-0">
...
<div id="checkoutModal" class="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-5 bg-slate-900/60 backdrop-blur-md hidden transition-all duration-300">
    <div id="modalBox" class="bg-white border-2 border-sky-200 rounded-3xl w-full max-w-4xl max-h-[92vh] flex flex-col overflow-hidden shadow-2xl transform scale-95 transition-transform duration-300">
        
        <!-- Modal Topbar -->
        <div class="flex items-center justify-between px-5 py-4 border-b-2 border-slate-100 bg-sky-50/60 flex-shrink-0">
            <div class="flex items-center gap-3">
                <div class="w-9 h-9 rounded-xl bg-sky-500 text-white flex items-center justify-center text-sm shadow-md shadow-sky-300">
                    <i class="fa-solid fa-bag-shopping"></i>
                </div>
                <div>
                    <h3 class="font-black text-slate-950 text-sm sm:text-base">Detail Produk & Pemesanan</h3>
                    <p class="text-[11px] font-bold text-slate-500">ItemPedia • Transaksi Instan & Terverifikasi Roblox</p>
                </div>
            </div>
            <button type="button" onclick="closeCheckoutModal()" class="w-8 h-8 rounded-xl bg-white hover:bg-slate-100 border border-slate-200 text-slate-600 hover:text-slate-900 flex items-center justify-center transition active:scale-90">
        ...
        <div class="overflow-y-auto p-5 sm:p-7 grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8 flex-grow">
            ...
            <div class="lg:col-span-6 flex flex-col space-y-4">
                ...
                <div class="aspect-video w-full rounded-2xl overflow-hidden bg-slate-100 border-2 border-slate-200 shadow-sm">
                    <img id="modalProductImage" src="" alt="Produk Roblox" class="w-full h-full object-cover">
                </div>

                <!-- Judul & Harga Satuan -->
                <div>
                    <h3 id="modalProductName" class="text-base sm:text-lg font-black text-slate-950 leading-snug"></h3>
                    <div class="flex items-baseline gap-2 mt-1 flex-wrap">
                        <span id="modalProductPrice" class="text-xl sm:text-2xl font-black text-orange-500"></span>
                        <span id="modalProductPriceOriginal" class="text-xs text-slate-400 line-through font-bold hidden"></span>
                        <span id="modalProductSold" class="text-xs text-slate-500 font-bold ml-auto"></span>
                    </div>
                </div>
                ...
                <div class="space-y-1.5 pt-1">
                    ...
                    <div id="modalProductDesc" class="p-3.5 bg-slate-50 border border-slate-200/90 rounded-2xl text-xs text-slate-600 leading-relaxed font-medium max-h-36 overflow-y-auto">
                    </div>
                </div>

                <!-- 3. Ulasan Produk -->
                <div class="space-y-1.5 pt-2 border-t border-slate-100 flex-grow">
                    <div class="flex items-center justify-between">
                        <h4 class="text-xs font-black uppercase tracking-wider text-slate-700 flex items-center gap-1.5">
                            <i class="fa-solid fa-comments text-amber-500"></i>
                            <span>Ulasan Pembeli</span>
                        </h4>
                        <span id="modalReviewHeaderCount" class="text-[11px] font-bold text-slate-400"></span>
                    </div>
            ...
            <div class="lg:col-span-6 bg-slate-50/70 p-4 sm:p-5 rounded-2xl border-2 border-sky-100 flex flex-col justify-between">
                ...
                <form action="/order/create" method="POST" id="checkoutForm" class="space-y-4">
                        ...
                        <div class="flex gap-2">
                            <div class="relative flex-grow">
                                <input type="text" 
                                       ...
                                       class="w-full pl-9 pr-3 py-2.5 bg-white border-2 border-slate-200 rounded-xl text-xs sm:text-sm text-slate-950 font-bold focus:outline-none focus:border-sky-500 transition">
                                <i class="fa-solid fa-user absolute left-3 top-1/2 -translate-y-1/2 text-slate-400 text-xs"></i>
                            </div>
                            <button type="button" 
                                    id="btnCheckRoblox"
                                    onclick="checkRobloxUser()"
                                    class="btn-shimmer px-4 py-2.5 bg-sky-500 hover:bg-sky-600 text-white font-black text-xs rounded-xl shadow-md shadow-sky-300 transition flex items-center gap-1.5 flex-shrink-0 active:scale-95">
                                <i class="fa-solid fa-magnifying-glass"></i>
                                <span>Cek Avatar</span>
                            </button>
                        </div>
                        <p class="text-[10px] font-semibold text-slate-400 mt-1">Klik "Cek Avatar" untuk mencocokkan karakter avatar Roblox.</p>

                        <!-- Box Hasil Cek Avatar Roblox -->
                        <div id="robloxAvatarBox" class="hidden mt-2.5 p-3 rounded-xl bg-sky-50 border-2 border-sky-300 flex items-center gap-3 shadow-sm">
                            ...
                            <div class="min-w-0">
                                <div class="flex items-center gap-1.5">
                                    <span id="robloxVerifiedUsername" class="font-black text-xs text-slate-950 truncate"></span>
                                    <span class="inline-flex items-center gap-1 text-[9px] font-extrabold text-emerald-800 bg-emerald-100 px-1.5 py-0.5 rounded border border-emerald-300">
                                        <i class="fa-solid fa-circle-check text-emerald-600"></i> Akun Valid
                                    </span>
                                </div>
                                <span id="robloxDisplayName" class="text-[11px] text-slate-600 block mt-0.5 font-bold"></span>
                            </div>
                        </div>

                        <!-- Box Error jika username tidak ada -->
                        <div id="robloxErrorBox" class="hidden mt-2 p-2.5 rounded-xl bg-rose-50 border-2 border-rose-200 text-[11px] font-bold text-rose-800 flex items-center gap-2">
                    ...
                    <div class="bg-white p-3.5 rounded-2xl border-2 border-slate-200/90 shadow-sm space-y-2">
                        <div class="flex items-center justify-between">
                            <label class="text-xs font-black text-slate-800 uppercase tracking-wider">
                                Jumlah Dibeli
                            </label>
                            <span id="modalQtyStockInfo" class="text-[11px] font-bold text-slate-500"></span>
                        </div>
                        ...
                        <div class="flex items-center justify-between gap-3">
                            ...
                            <div class="flex items-center border-2 border-slate-200 rounded-xl overflow-hidden bg-slate-50">
                                <button type="button" 
                                        ...
                                        class="w-8 h-8 flex items-center justify-center text-slate-600 hover:bg-slate-200 active:scale-95 transition font-black">
                                ...
                                <input type="number" 
                                       ...
                                       class="w-12 text-center text-xs font-black bg-white py-1.5 focus:outline-none border-x-2 border-slate-200 text-slate-900">
                                <button type="button" 
                                        onclick="changeQuantity(1)" 
                                        class="w-8 h-8 flex items-center justify-center text-slate-600 hover:bg-slate-200 active:scale-95 transition font-black">
                            ...
                            <div class="text-right">
                                <span class="text-[10px] font-extrabold text-slate-400 uppercase tracking-wider block">Total Harga:</span>
                                <div class="flex flex-col items-end">
                                    <span id="modalDiscountBadge" class="hidden text-[10px] font-black text-emerald-600 bg-emerald-50 px-1.5 py-0.5 rounded border border-emerald-200 mb-0.5">
                                        Hemat -Rp 0
                                    </span>
                                    <span id="modalSubtotalStrikethrough" class="hidden text-[11px] font-bold text-slate-400 line-through">Rp 0</span>
                                    <span id="modalTotalPrice" class="text-base font-black text-orange-600">Rp 0</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white p-3.5 rounded-2xl border-2 border-slate-200/90 shadow-sm space-y-2.5">
                        <div class="flex items-center justify-between">
                        ...
                        <div class="flex gap-2">
                            ...
                            <button type="button" 
                                    ...
                                    class="px-4 py-2.5 bg-amber-500 hover:bg-amber-600 active:scale-95 text-white font-black text-xs rounded-xl shadow-sm transition flex items-center gap-1.5 flex-shrink-0">
                                <i class="fa-solid fa-check"></i>
                                <span>Pakai</span>
                            </button>
                        </div>
                        ...
                        <div id="redeemStatusBox" class="hidden text-xs rounded-xl p-2.5 items-start gap-2">
                            ...
                            <button type="button" id="btnCancelRedeemInBox" onclick="cancelRedeemCode()" class="text-[10px] font-bold underline ml-auto text-emerald-700 hover:text-emerald-900">
                                Batal
                            </button>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="note" 
                                  ...
                                  class="w-full px-3 py-2 bg-white border-2 border-slate-200 rounded-xl text-xs text-slate-950 font-medium focus:outline-none focus:border-sky-500 transition resize-none"></textarea>
                    </div>
                    ...
                    <div class="pt-2 space-y-2.5">
                        <div class="flex items-center gap-2">
                            <button type="button" 
                                    ...
                                    class="flex-1 py-3 px-3 bg-sky-50 hover:bg-sky-100 active:scale-95 text-sky-700 font-bold text-xs sm:text-sm rounded-2xl border-2 border-sky-200 transition flex items-center justify-center gap-1.5 cursor-pointer">
                                <i class="fa-solid fa-cart-plus text-sky-600"></i>
                                <span>Keranjang</span>
                            </button>
                            <button type="submit" 
                                    id="btnSubmitOrder"
                        ...
                        <div class="flex items-center justify-between text-[10px] font-bold text-slate-400 px-1">
        ...
        if (!reviews || reviews.length === 0) {
            ...
            container.innerHTML = `
                <div class="p-3 rounded-xl bg-slate-50 border border-slate-200/80 text-center">
                    <p class="text-xs font-bold text-slate-500">Belum ada ulasan untuk produk ini.</p>
                    <p class="text-[10px] text-slate-400 mt-0.5">Jadilah pembeli pertama yang memberikan ulasan!</p>
                </div>
            `;
            return;
        }
        ...
        reviews.forEach(rev => {
            ...
            html += `
                <div class="p-2.5 rounded-xl bg-slate-50 border border-slate-200/70 space-y-1.5">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-2">
                            <img src="${avatar}" alt="" class="w-6 h-6 rounded-full bg-white border border-slate-200 object-cover flex-shrink-0" onerror="this.src='https://ui-avatars.com/api/?name=Roblox&background=38bdf8&color=fff'">
                            <span class="text-xs font-black text-slate-900">@${escapeHtml(rev.roblox_username)}</span>
                        </div>
                        <div class="flex items-center gap-0.5">
                            ${stars}
                        </div>
                    </div>
                    <p class="text-[11px] text-slate-600 font-medium leading-relaxed italic pl-1 border-l-2 border-sky-400">
